...
<body className='snippet-body'>
    ...
    <body id="body-pd">
        ...
        <?php
        $id_user = $id_usuario;
        $querys = "SELECT * FROM usuarios WHERE id_login='$id_user'";
        $results = mysqli_query($link, $querys);
        while ($arrays = mysqli_fetch_assoc($results)) {
        ?>
    

        <?php
        $id_liv = $arrays['id_livro'];
        $query = "SELECT * FROM livros WHERE id='$id_liv'";
        ...
        <div class="galeria">
            <div class="infor">
                ...
                <span><b>Gênero:</b> <?=$array['Classificacao']?></span><br>
