    ...
    <body id="body-pd">
        <header class="header" id="header">
            ...
            <?php
                ...
                $query = "SELECT * FROM acesso WHERE id='$id_usuario'";
                $result = mysqli_query($link, $query);
                while ($array = mysqli_fetch_assoc($result)) {
                ?>
            <span><b>Login:</b> <?=$array['nome']?></span><div class="header_img"> <img src="./img/logo_pessoa.jpg" alt=""> </div>
            <?php } ?>
        </header>
